...
//
	init:;
	mov 0,[Localization_stack_index]
		mov	0, SPR_PSM_0x4e;			
		mov	0, SPR_PSM_0x0c;						
...
//
	...
	tx_end_completed:;
	    or	SPR_TSF_WORD0, 0x000, [Local_Clock_timeStamp_TX_end_LO]; /* mem[Local_Clock_timeStamp_TX_end_LO] = SPR_TSF_word_0 */
...
//
	rx_complete:;
       or	SPR_TSF_WORD0, 0x000, [Local_Clock_timeStamp_RX_Compelet_Lo]; /* mem[Local_Clock_timeStamp_RX_Compelet_Lo] = SPR_TSF_word_0 */
...
//
	rx_ack:;
	    sub [Local_Clock_timeStamp_RX_Compelet_Lo], [Local_Clock_timeStamp_TX_end_LO],[]
...
//
	...
	end_txe0_control_for_edcf:;
		...
		// ***********************************************************************************************
// FUNCTION:	Push for localization measurment	
// PURPOSE:	we need to save the subtract time to shared memory as well the info about the fram in a standard way
//
	push_localization_measurment:;
		jne	0x28, [Localization_stack_index],start_push;						
		mov 0x00,[Localization_stack_index]; 
		start_push:;
		add 0x02,[Localization_stack_index],[Localization_stack_index];
		mov
		sub [Local_Clock_timeStamp_RX_Compelet_Lo],[Local_Clock_timeStamp_TX_end_LO],[Localization_stack_Base+[[Localization_stack_index]]];
		ret	lr0, lr0;
